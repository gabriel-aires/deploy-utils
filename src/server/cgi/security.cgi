...
# Operação...
echo "              <p>Operação:</p>"
echo "              <input type=\"radio\" name=\"operation\" value=\"$operation_erase\"><br>"
echo "              <input type=\"radio\" name=\"operation\" value=\"$operation_groups\"><br>"
echo "              <input type=\"radio\" name=\"operation\" value=\"$operation_permissions\" checked><br>"
# Submit
echo "              <input type=\"submit\" name=\"submit\" value=\"$submit_continue\">"
echo "          </form>"
echo "      </p>"
